...
void drawPeakWidthComp(const char * particle, bool isprob=false)
{
  ...
  c1->SaveAs(Form("plot_comp_%s_isprob%d_peak.pdf",particle,isprob));
  ...
  drawText("p_{T}^{#gamma} > 0.5 GeV",sPHENIX_posx,sPHENIX_posy-posy_diff*3,1,18);
  drawText("#alpha < 0.6",sPHENIX_posx,sPHENIX_posy-posy_diff*4,1,18);
  if(isprob) drawText("#gamma prob. > 0.05",sPHENIX_posx,sPHENIX_posy-posy_diff*5,1,18);
  drawText(formattedparticle,sPHENIX_posx,sPHENIX_posy-posy_diff*6,1,18);
  ...
  c2->SaveAs(Form("plot_comp_%s_isprob%d_res.pdf",particle,isprob));
  ...
  l3->Draw("same");
  c3->SaveAs(Form("plot_comp_%s_isprob%d_width_div_peak.pdf",particle,isprob));
  ...
  l->Draw("same");
  c4->SaveAs(Form("plot_comp_%s_isprob%d_peak_ratio.pdf",particle,isprob));
