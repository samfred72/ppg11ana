...
void Fun4All_macro_mc20(const char * inqueue="queue_run21_v00000.list", bool isMC=true, bool isEmbed=false, float mbdzvtxcut = -999)
{
    string infile = Form("/sphenix/user/samfred/run25/ppg11/treemaking/macros/filelists/pythia_Jet20/%s",inqueue);
    ...
    string outdir = Form("/sphenix/tg/tg01/jets/samfred/run25/pythia_Jet20");
